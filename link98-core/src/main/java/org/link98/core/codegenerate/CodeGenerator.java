 ...
 */
package org.link98.core.codegenerate;
...
public class CodeGenerator {
	...
	private static final String JAVA_DAO_ROOT = PRJ_ROOT + "\\src\\me\\link98\\core\\dao";
	private static final String JAVA_SERVICE_ROOT = PRJ_ROOT + "\\src\\me\\link98\\core\\service";
	private static final String MYBATIS_ROOT = PRJ_ROOT + "\\resouces\\mapper";
	private static final String DDL_ROOT = PRJ_ROOT + "\\resouces\\ddl";
	
	private static final String TEMPLATE_ROOT = PRJ_ROOT + "\\resouces\\template\\";
	
	public static void main(String[] args) throws IOException, TemplateException {
		Class<?> clazz = CodeGenerator.class;//这里填写要生成的实体类名
		generate(clazz);
	}
