 ...
 *  AbstractDao.java
 */
package org.link98.core.dao.impl;
...
import org.link98.core.domains.AbstractRecordBean;
import org.link98.core.utils.Pagination;
import org.link98.core.utils.mybatis.page.CountParameter;
...
public abstract class AbstractDao<T extends AbstractBean> extends SqlSessionDaoSupport implements BaseDao<T> {
	...
	public int insert(T entity) {
		...
		int idOrCount = getSqlSession().insert(getNameSapce() + INSERT , entity);
		return entity.getId() == null? idOrCount : entity.getId();
	}
